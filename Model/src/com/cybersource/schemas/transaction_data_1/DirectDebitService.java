...
@XmlType(name = "DirectDebitService", propOrder = {
         "dateCollect", "directDebitText", "authorizationID", "transactionType", "directDebitType", "validateRequestID",
         "recurringType", "mandateID", "validateRequestToken", "reconciliationID", "mandateAuthenticationDate"
    })
