 ...
 *         &lt;element name="deniedPartiesMatch" type="{urn:schemas-cybersource-com:transaction-data-1.137}DeniedPartiesMatch" maxOccurs="100" minOccurs="0"/&gt;
 *         &lt;element name="ccAuthReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}CCAuthReply" minOccurs="0"/&gt;
 *         &lt;element name="octReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}OCTReply" minOccurs="0"/&gt;
 *         &lt;element name="verificationReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}VerificationReply" minOccurs="0"/&gt;
 *         &lt;element name="ccSaleReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}CCSaleReply" minOccurs="0"/&gt;
 *         &lt;element name="ccSaleCreditReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}CCSaleCreditReply" minOccurs="0"/&gt;
 *         &lt;element name="ccSaleReversalReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}CCSaleReversalReply" minOccurs="0"/&gt;
 *         &lt;element name="ccIncrementalAuthReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}CCIncrementalAuthReply" minOccurs="0"/&gt;
 *         &lt;element name="serviceFeeCalculateReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}ServiceFeeCalculateReply" minOccurs="0"/&gt;
 *         &lt;element name="ccCaptureReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}CCCaptureReply" minOccurs="0"/&gt;
 *         &lt;element name="ccCreditReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}CCCreditReply" minOccurs="0"/&gt;
 *         &lt;element name="ccAuthReversalReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}CCAuthReversalReply" minOccurs="0"/&gt;
 *         &lt;element name="ccAutoAuthReversalReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}CCAutoAuthReversalReply" minOccurs="0"/&gt;
 *         &lt;element name="ccDCCReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}CCDCCReply" minOccurs="0"/&gt;
 *         &lt;element name="ccDCCUpdateReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}CCDCCUpdateReply" minOccurs="0"/&gt;
 *         &lt;element name="ecDebitReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}ECDebitReply" minOccurs="0"/&gt;
 *         &lt;element name="ecCreditReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}ECCreditReply" minOccurs="0"/&gt;
 *         &lt;element name="ecAuthenticateReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}ECAuthenticateReply" minOccurs="0"/&gt;
 *         &lt;element name="payerAuthEnrollReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}PayerAuthEnrollReply" minOccurs="0"/&gt;
 *         &lt;element name="payerAuthValidateReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}PayerAuthValidateReply" minOccurs="0"/&gt;
 *         &lt;element name="taxReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}TaxReply" minOccurs="0"/&gt;
 *         &lt;element name="encryptedPayment" type="{urn:schemas-cybersource-com:transaction-data-1.137}EncryptedPayment" minOccurs="0"/&gt;
 *         &lt;element name="encryptPaymentDataReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}EncryptPaymentDataReply" minOccurs="0"/&gt;
 *         &lt;element name="dmeReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}DMEReply" minOccurs="0"/&gt;
 *         &lt;element name="afsReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}AFSReply" minOccurs="0"/&gt;
 *         &lt;element name="davReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}DAVReply" minOccurs="0"/&gt;
 *         &lt;element name="exportReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}ExportReply" minOccurs="0"/&gt;
 *         &lt;element name="fxRatesReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}FXRatesReply" minOccurs="0"/&gt;
 *         &lt;element name="bankTransferReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}BankTransferReply" minOccurs="0"/&gt;
 *         &lt;element name="bankTransferRefundReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}BankTransferRefundReply" minOccurs="0"/&gt;
 *         &lt;element name="bankTransferRealTimeReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}BankTransferRealTimeReply" minOccurs="0"/&gt;
 *         &lt;element name="directDebitMandateReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}DirectDebitMandateReply" minOccurs="0"/&gt;
 *         &lt;element name="directDebitReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}DirectDebitReply" minOccurs="0"/&gt;
 *         &lt;element name="directDebitValidateReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}DirectDebitValidateReply" minOccurs="0"/&gt;
 *         &lt;element name="directDebitRefundReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}DirectDebitRefundReply" minOccurs="0"/&gt;
 *         &lt;element name="paySubscriptionCreateReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}PaySubscriptionCreateReply" minOccurs="0"/&gt;
 *         &lt;element name="paySubscriptionUpdateReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}PaySubscriptionUpdateReply" minOccurs="0"/&gt;
 *         &lt;element name="paySubscriptionEventUpdateReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}PaySubscriptionEventUpdateReply" minOccurs="0"/&gt;
 *         &lt;element name="paySubscriptionRetrieveReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}PaySubscriptionRetrieveReply" minOccurs="0"/&gt;
 *         &lt;element name="paySubscriptionDeleteReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}PaySubscriptionDeleteReply" minOccurs="0"/&gt;
 *         &lt;element name="payPalPaymentReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}PayPalPaymentReply" minOccurs="0"/&gt;
 *         &lt;element name="payPalCreditReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}PayPalCreditReply" minOccurs="0"/&gt;
 *         &lt;element name="voidReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}VoidReply" minOccurs="0"/&gt;
 *         &lt;element name="pinlessDebitReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}PinlessDebitReply" minOccurs="0"/&gt;
 *         &lt;element name="pinlessDebitValidateReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}PinlessDebitValidateReply" minOccurs="0"/&gt;
 *         &lt;element name="pinlessDebitReversalReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}PinlessDebitReversalReply" minOccurs="0"/&gt;
 *         &lt;element name="payPalButtonCreateReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}PayPalButtonCreateReply" minOccurs="0"/&gt;
 *         &lt;element name="payPalPreapprovedPaymentReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}PayPalPreapprovedPaymentReply" minOccurs="0"/&gt;
 *         &lt;element name="payPalPreapprovedUpdateReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}PayPalPreapprovedUpdateReply" minOccurs="0"/&gt;
 *         &lt;element name="riskUpdateReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}RiskUpdateReply" minOccurs="0"/&gt;
 *         &lt;element name="fraudUpdateReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}FraudUpdateReply" minOccurs="0"/&gt;
 *         &lt;element name="caseManagementActionReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}CaseManagementActionReply" minOccurs="0"/&gt;
 *         &lt;element name="decisionReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}DecisionReply" minOccurs="0"/&gt;
 *         &lt;element name="payPalRefundReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}PayPalRefundReply" minOccurs="0"/&gt;
 *         &lt;element name="payPalAuthReversalReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}PayPalAuthReversalReply" minOccurs="0"/&gt;
 *         &lt;element name="payPalDoCaptureReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}PayPalDoCaptureReply" minOccurs="0"/&gt;
 *         &lt;element name="payPalEcDoPaymentReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}PayPalEcDoPaymentReply" minOccurs="0"/&gt;
 *         &lt;element name="payPalEcGetDetailsReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}PayPalEcGetDetailsReply" minOccurs="0"/&gt;
 *         &lt;element name="payPalEcSetReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}PayPalEcSetReply" minOccurs="0"/&gt;
 *         &lt;element name="payPalAuthorizationReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}PayPalAuthorizationReply" minOccurs="0"/&gt;
 *         &lt;element name="payPalEcOrderSetupReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}PayPalEcOrderSetupReply" minOccurs="0"/&gt;
 *         &lt;element name="payPalUpdateAgreementReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}PayPalUpdateAgreementReply" minOccurs="0"/&gt;
 *         &lt;element name="payPalCreateAgreementReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}PayPalCreateAgreementReply" minOccurs="0"/&gt;
 *         &lt;element name="payPalDoRefTransactionReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}PayPalDoRefTransactionReply" minOccurs="0"/&gt;
 *         &lt;element name="chinaPaymentReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}ChinaPaymentReply" minOccurs="0"/&gt;
 *         &lt;element name="chinaRefundReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}ChinaRefundReply" minOccurs="0"/&gt;
 *         &lt;element name="boletoPaymentReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}BoletoPaymentReply" minOccurs="0"/&gt;
 *         &lt;element name="pinDebitPurchaseReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}PinDebitPurchaseReply" minOccurs="0"/&gt;
 *         &lt;element name="pinDebitCreditReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}PinDebitCreditReply" minOccurs="0"/&gt;
 *         &lt;element name="pinDebitReversalReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}PinDebitReversalReply" minOccurs="0"/&gt;
 *         &lt;element name="apInitiateReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}APInitiateReply" minOccurs="0"/&gt;
 *         &lt;element name="apCheckStatusReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}APCheckStatusReply" minOccurs="0"/&gt;
 ...
 *         &lt;element name="apReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}APReply" minOccurs="0"/&gt;
 ...
 *         &lt;element name="apAuthReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}APAuthReply" minOccurs="0"/&gt;
 *         &lt;element name="apSessionsReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}APSessionsReply" minOccurs="0"/&gt;
 *         &lt;element name="apAuthReversalReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}APAuthReversalReply" minOccurs="0"/&gt;
 *         &lt;element name="apCaptureReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}APCaptureReply" minOccurs="0"/&gt;
 *         &lt;element name="apOptionsReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}APOptionsReply" minOccurs="0"/&gt;
 *         &lt;element name="apRefundReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}APRefundReply" minOccurs="0"/&gt;
 *         &lt;element name="apSaleReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}APSaleReply" minOccurs="0"/&gt;
 *         &lt;element name="apCheckoutDetailsReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}APCheckOutDetailsReply" minOccurs="0"/&gt;
 *         &lt;element name="apTransactionDetailsReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}APTransactionDetailsReply" minOccurs="0"/&gt;
 *         &lt;element name="apConfirmPurchaseReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}APConfirmPurchaseReply" minOccurs="0"/&gt;
 *         &lt;element name="promotion" type="{urn:schemas-cybersource-com:transaction-data-1.137}Promotion" minOccurs="0"/&gt;
 *         &lt;element name="promotionGroup" type="{urn:schemas-cybersource-com:transaction-data-1.137}PromotionGroupReply" maxOccurs="100" minOccurs="0"/&gt;
 *         &lt;element name="payPalGetTxnDetailsReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}PayPalGetTxnDetailsReply" minOccurs="0"/&gt;
 *         &lt;element name="payPalTransactionSearchReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}PayPalTransactionSearchReply" minOccurs="0"/&gt;
 *         &lt;element name="emvReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}EmvReply" minOccurs="0"/&gt;
 *         &lt;element name="originalTransaction" type="{urn:schemas-cybersource-com:transaction-data-1.137}OriginalTransaction" minOccurs="0"/&gt;
 *         &lt;element name="hostedDataCreateReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}HostedDataCreateReply" minOccurs="0"/&gt;
 *         &lt;element name="hostedDataRetrieveReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}HostedDataRetrieveReply" minOccurs="0"/&gt;
 ...
 *         &lt;element name="vcReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}VCReply" minOccurs="0"/&gt;
 *         &lt;element name="decryptVisaCheckoutDataReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}DecryptVisaCheckoutDataReply" minOccurs="0"/&gt;
 *         &lt;element name="getVisaCheckoutDataReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}GetVisaCheckoutDataReply" minOccurs="0"/&gt;
 *         &lt;element name="binLookupReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}BinLookupReply" minOccurs="0"/&gt;
 *         &lt;element name="issuerMessage" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *         &lt;element name="token" type="{urn:schemas-cybersource-com:transaction-data-1.137}Token" minOccurs="0"/&gt;
 ...
 *         &lt;element name="apOrderReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}APOrderReply" minOccurs="0"/&gt;
 *         &lt;element name="apCancelReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}APCancelReply" minOccurs="0"/&gt;
 *         &lt;element name="apBillingAgreementReply" type="{urn:schemas-cybersource-com:transaction-data-1.137}APBillingAgreementReply" minOccurs="0"/&gt;
 *         &lt;element name="customerVerificationStatus" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *         &lt;element name="reserved" type="{urn:schemas-cybersource-com:transaction-data-1.137}ReplyReserved" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "ReplyMessage", propOrder = {
         "merchantReferenceCode", "requestID", "decision", "reasonCode", "missingField", "invalidField", "requestToken",
         "purchaseTotals", "deniedPartiesMatch", "ccAuthReply", "octReply", "verificationReply", "ccSaleReply",
         "ccSaleCreditReply", "ccSaleReversalReply", "ccIncrementalAuthReply", "serviceFeeCalculateReply",
         "ccCaptureReply", "ccCreditReply", "ccAuthReversalReply", "ccAutoAuthReversalReply", "ccDCCReply",
         "ccDCCUpdateReply", "ecDebitReply", "ecCreditReply", "ecAuthenticateReply", "payerAuthEnrollReply",
         "payerAuthValidateReply", "taxReply", "encryptedPayment", "encryptPaymentDataReply", "dmeReply", "afsReply",
         "davReply", "exportReply", "fxRatesReply", "bankTransferReply", "bankTransferRefundReply",
         "bankTransferRealTimeReply", "directDebitMandateReply", "directDebitReply", "directDebitValidateReply",
         "directDebitRefundReply", "paySubscriptionCreateReply", "paySubscriptionUpdateReply",
         "paySubscriptionEventUpdateReply", "paySubscriptionRetrieveReply", "paySubscriptionDeleteReply",
         "payPalPaymentReply", "payPalCreditReply", "voidReply", "pinlessDebitReply", "pinlessDebitValidateReply",
         "pinlessDebitReversalReply", "payPalButtonCreateReply", "payPalPreapprovedPaymentReply",
         "payPalPreapprovedUpdateReply", "riskUpdateReply", "fraudUpdateReply", "caseManagementActionReply",
         "decisionReply", "payPalRefundReply", "payPalAuthReversalReply", "payPalDoCaptureReply",
         "payPalEcDoPaymentReply", "payPalEcGetDetailsReply", "payPalEcSetReply", "payPalAuthorizationReply",
         "payPalEcOrderSetupReply", "payPalUpdateAgreementReply", "payPalCreateAgreementReply",
         "payPalDoRefTransactionReply", "chinaPaymentReply", "chinaRefundReply", "boletoPaymentReply",
         "pinDebitPurchaseReply", "pinDebitCreditReply", "pinDebitReversalReply", "apInitiateReply",
         "apCheckStatusReply", "receiptNumber", "additionalData", "solutionProviderTransactionID", "apReply", "shipTo",
         "billTo", "apAuthReply", "apSessionsReply", "apAuthReversalReply", "apCaptureReply", "apOptionsReply",
         "apRefundReply", "apSaleReply", "apCheckoutDetailsReply", "apTransactionDetailsReply",
         "apConfirmPurchaseReply", "promotion", "promotionGroup", "payPalGetTxnDetailsReply",
         "payPalTransactionSearchReply", "emvReply", "originalTransaction", "hostedDataCreateReply",
         "hostedDataRetrieveReply", "salesSlipNumber", "additionalProcessorResponse", "jpo", "card",
         "paymentNetworkToken", "vcReply", "decryptVisaCheckoutDataReply", "getVisaCheckoutDataReply", "binLookupReply",
         "issuerMessage", "token", "issuer", "recipient", "feeProgramIndicator", "installment",
         "paymentAccountReference", "authIndicator", "ucaf", "apOrderReply", "apCancelReply", "apBillingAgreementReply",
         "customerVerificationStatus", "reserved"
    })
