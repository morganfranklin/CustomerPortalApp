...
@XmlType(name = "CCCreditReply", propOrder = {
         "reasonCode", "requestDateTime", "amount", "reconciliationID", "purchasingLevel3Enabled",
         "enhancedDataEnabled", "authorizationXID", "forwardCode", "ownerMerchantID", "reconciliationReferenceNumber"
    })
