...
@XmlType(name = "PayPalPreapprovedPaymentReply", propOrder = {
         "reasonCode", "requestDateTime", "reconciliationID", "payerStatus", "payerName", "transactionType",
         "feeAmount", "payerCountry", "pendingReason", "paymentStatus", "mpStatus", "payer", "payerID", "payerBusiness",
         "transactionID", "desc", "mpMax", "paymentType", "paymentDate", "paymentGrossAmount", "settleAmount",
         "taxAmount", "exchangeRate", "paymentSourceID"
    })
