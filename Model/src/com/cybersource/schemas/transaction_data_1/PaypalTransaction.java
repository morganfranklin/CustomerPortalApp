 ...
 *       &lt;sequence&gt;
 *         &lt;element name="transactionTime" type="{urn:schemas-cybersource-com:transaction-data-1.137}dateTime" minOccurs="0"/&gt;
...
@XmlType(name = "PaypalTransaction", propOrder = {
         "transactionTime", "transactionTimeZone", "transactionType", "paypalPayerOrPayeeEmail", "customerDisplayName",
         "transactionID", "paypalPaymentStatus", "grandTotalAmount", "currency", "paypalFeeAmount", "paypalNetAmount"
    })
