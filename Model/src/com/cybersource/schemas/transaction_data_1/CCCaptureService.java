...
@XmlType(name = "CCCaptureService", propOrder = {
         "authType", "verbalAuthCode", "authRequestID", "reconciliationID", "partialPaymentID", "purchasingLevel",
         "industryDatatype", "authRequestToken", "merchantReceiptNumber", "posData", "transactionID", "checksumKey",
         "gratuityAmount", "duration", "dpdeBillingMonth", "sequence", "totalCount", "reconciliationIDAlternate",
