...
@XmlType(name = "HostedDataRetrieveReply", propOrder = {
         "responseMessage", "reasonCode", "aggregatorMerchantIdentifier", "customerFirstName", "customerLastName",
         "customerID", "paymentMethod", "billToStreet1", "billToStreet2", "billToEmail", "billToState",
         "billToFirstName", "billToLastName", "billToCity", "billToCountry", "billToPostalCode", "cardAccountNumber",
         "cardType", "cardExpirationMonth", "cardExpirationYear", "cardIssueNumber", "cardStartMonth", "cardStartYear"
    })
