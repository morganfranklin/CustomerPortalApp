 ...
 *         &lt;element name="totalFee" type="{urn:schemas-cybersource-com:transaction-data-1.137}amount" minOccurs="0"/&gt;
 ...
 *         &lt;element name="totalClearingAmount" type="{urn:schemas-cybersource-com:transaction-data-1.137}amount" minOccurs="0"/&gt;
 *         &lt;element name="leg" type="{urn:schemas-cybersource-com:transaction-data-1.137}Leg" maxOccurs="1000" minOccurs="0"/&gt;
 ...
 *         &lt;element name="exchangeTicketAmount" type="{urn:schemas-cybersource-com:transaction-data-1.137}amount" minOccurs="0"/&gt;
 *         &lt;element name="exchangeTicketFee" type="{urn:schemas-cybersource-com:transaction-data-1.137}amount" minOccurs="0"/&gt;
...
@XmlType(name = "AirlineData", propOrder = {
         "agentCode", "agentName", "ticketIssuerCity", "ticketIssuerState", "ticketIssuerPostalCode",
         "ticketIssuerCountry", "ticketIssuerAddress", "ticketIssuerCode", "ticketIssuerName", "ticketNumber",
         "checkDigit", "restrictedTicketIndicator", "transactionType", "extendedPaymentCode", "carrierName",
         "passengerName", "customerCode", "documentType", "documentNumber", "documentNumberOfParts", "invoiceNumber",
         "invoiceDate", "chargeDetails", "bookingReference", "totalFee", "clearingSequence", "clearingCount",
         "totalClearingAmount", "leg", "numberOfPassengers", "reservationSystem", "processIdentifier",
         "iataNumericCode", "ticketIssueDate", "electronicTicket", "originalTicketNumber", "purchaseType",
         "creditReasonIndicator", "ticketUpdateIndicator", "planNumber", "arrivalDate", "ticketRestrictionText",
         "exchangeTicketAmount", "exchangeTicketFee", "journeyType"
    })
