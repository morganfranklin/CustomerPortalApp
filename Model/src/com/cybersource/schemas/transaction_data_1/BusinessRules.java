 ...
 *       &lt;sequence&gt;
 *         &lt;element name="ignoreAVSResult" type="{urn:schemas-cybersource-com:transaction-data-1.137}boolean" minOccurs="0"/&gt;
 *         &lt;element name="ignoreCVResult" type="{urn:schemas-cybersource-com:transaction-data-1.137}boolean" minOccurs="0"/&gt;
 *         &lt;element name="ignoreDAVResult" type="{urn:schemas-cybersource-com:transaction-data-1.137}boolean" minOccurs="0"/&gt;
 *         &lt;element name="ignoreExportResult" type="{urn:schemas-cybersource-com:transaction-data-1.137}boolean" minOccurs="0"/&gt;
 *         &lt;element name="ignoreValidateResult" type="{urn:schemas-cybersource-com:transaction-data-1.137}boolean" minOccurs="0"/&gt;
...
@XmlType(name = "BusinessRules", propOrder = {
         "ignoreAVSResult", "ignoreCVResult", "ignoreDAVResult", "ignoreExportResult", "ignoreValidateResult",
