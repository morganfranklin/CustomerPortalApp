...
@XmlType(name = "PayPalDoRefTransactionReply", propOrder = {
         "reasonCode", "paypalBillingAgreementId", "transactionId", "paypalTransactionType", "paypalPaymentType",
         "paypalOrderTime", "paypalAmount", "currency", "paypalTaxAmount", "paypalExchangeRate", "paypalPaymentStatus",
         "paypalPendingReason", "paypalReasonCode", "errorCode", "correlationID"
    })
