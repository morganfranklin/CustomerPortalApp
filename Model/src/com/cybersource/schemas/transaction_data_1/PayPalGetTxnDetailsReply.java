...
@XmlType(name = "PayPalGetTxnDetailsReply", propOrder = {
         "reasonCode", "payer", "payerId", "payerStatus", "payerCountry", "payerBusiness", "payerSalutation",
         "payerFirstname", "payerMiddlename", "payerLastname", "payerSuffix", "addressID", "addressStatus",
         "shipToName", "shipToAddress1", "shipToAddress2", "shipToCity", "shipToState", "shipToCountry", "shipToZip",
         "payerPhone", "transactionId", "parentTransactionId", "paypalReceiptId", "paypalTransactiontype",
         "paypalPaymentType", "paypalOrderTime", "paypalPaymentGrossAmount", "paypalFeeAmount", "currency",
         "paypalSettleAmount", "paypalTaxAmount", "paypalExchangeRate", "paypalPaymentStatus", "paypalPendingReason",
         "paypalReasonCode", "protectionEligibility", "protectionEligibilityType", "paypalNote", "invoiceNumber",
         "item", "errorCode"
    })
