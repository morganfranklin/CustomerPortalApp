 ...
 *       &lt;sequence&gt;
 *         &lt;element name="customerBillingAddressChange" type="{urn:schemas-cybersource-com:transaction-data-1.137}boolean" minOccurs="0"/&gt;
 *         &lt;element name="customerEmailChange" type="{urn:schemas-cybersource-com:transaction-data-1.137}boolean" minOccurs="0"/&gt;
 *         &lt;element name="customerHasCheckingAccount" type="{urn:schemas-cybersource-com:transaction-data-1.137}boolean" minOccurs="0"/&gt;
 *         &lt;element name="customerHasSavingsAccount" type="{urn:schemas-cybersource-com:transaction-data-1.137}boolean" minOccurs="0"/&gt;
 *         &lt;element name="customerPasswordChange" type="{urn:schemas-cybersource-com:transaction-data-1.137}boolean" minOccurs="0"/&gt;
 *         &lt;element name="customerPhoneChange" type="{urn:schemas-cybersource-com:transaction-data-1.137}boolean" minOccurs="0"/&gt;
 ...
 *         &lt;element name="grossHouseholdIncome" type="{urn:schemas-cybersource-com:transaction-data-1.137}amount" minOccurs="0"/&gt;
...
@XmlType(name = "BML", propOrder = {
         "customerBillingAddressChange", "customerEmailChange", "customerHasCheckingAccount",
         "customerHasSavingsAccount", "customerPasswordChange", "customerPhoneChange", "customerRegistrationDate",
         "customerTypeFlag", "grossHouseholdIncome", "householdIncomeCurrency", "itemCategory", "merchantPromotionCode",
         "preapprovalNumber", "productDeliveryTypeIndicator", "residenceStatus", "tcVersion", "yearsAtCurrentResidence",
         "yearsWithCurrentEmployer", "employerStreet1", "employerStreet2", "employerCity", "employerCompanyName",
         "employerCountry", "employerPhoneNumber", "employerPhoneType", "employerState", "employerPostalCode",
         "shipToPhoneType", "billToPhoneType", "methodOfPayment", "productType", "customerAuthenticatedByMerchant",
         "backOfficeIndicator", "shipToEqualsBillToNameIndicator", "shipToEqualsBillToAddressIndicator",
         "alternateIPAddress", "businessLegalName", "dbaName", "businessAddress1", "businessAddress2", "businessCity",
         "businessState", "businessPostalCode", "businessCountry", "businessMainPhone", "userID", "pin",
         "adminLastName", "adminFirstName", "adminPhone", "adminFax", "adminEmailAddress", "adminTitle",
         "supervisorLastName", "supervisorFirstName", "supervisorEmailAddress", "businessDAndBNumber", "businessTaxID",
         "businessNAICSCode", "businessType", "businessYearsInBusiness", "businessNumberOfEmployees",
         "businessPONumber", "businessLoanType", "businessApplicationID", "businessProductCode", "pgLastName",
         "pgFirstName", "pgSSN", "pgDateOfBirth", "pgAnnualIncome", "pgIncomeCurrencyType", "pgResidenceStatus",
         "pgCheckingAccountIndicator", "pgSavingsAccountIndicator", "pgYearsAtEmployer", "pgYearsAtResidence",
         "pgHomeAddress1", "pgHomeAddress2", "pgHomeCity", "pgHomeState", "pgHomePostalCode", "pgHomeCountry",
         "pgEmailAddress", "pgHomePhone", "pgTitle"
    })
public class BML {
