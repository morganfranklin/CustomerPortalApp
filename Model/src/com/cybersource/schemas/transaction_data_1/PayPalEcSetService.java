...
@XmlType(name = "PayPalEcSetService", propOrder = {
         "paypalReturn", "paypalCancelReturn", "paypalMaxamt", "paypalCustomerEmail", "paypalDesc",
         "paypalReqconfirmshipping", "paypalNoshipping", "paypalAddressOverride", "paypalToken", "paypalLc",
         "paypalPagestyle", "paypalHdrimg", "paypalHdrbordercolor", "paypalHdrbackcolor", "paypalPayflowcolor",
         "paypalEcSetRequestID", "paypalEcSetRequestToken", "promoCode0", "requestBillingAddress", "invoiceNumber",
         "paypalBillingType", "paypalBillingAgreementDesc", "paypalPaymentType", "paypalBillingAgreementCustom",
         "paypalLogoimg"
    })
