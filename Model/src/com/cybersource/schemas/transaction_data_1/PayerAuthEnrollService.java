 ...
 *         &lt;element name="purchaseTime" type="{urn:schemas-cybersource-com:transaction-data-1.137}dateTime" minOccurs="0"/&gt;
...
@XmlType(name = "PayerAuthEnrollService", propOrder = {
         "httpAccept", "httpUserAgent", "merchantName", "merchantURL", "purchaseDescription", "purchaseTime",
         "countryCode", "acquirerBin", "loginID", "password", "merchantID", "overridePaymentMethod", "mobilePhone",
         "mcc", "productCode"
    })
