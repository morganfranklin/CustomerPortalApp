...
@XmlType(name = "DAVReply", propOrder = {
         "reasonCode", "addressType", "apartmentInfo", "barCode", "barCodeCheckDigit", "careOf", "cityInfo",
         "countryInfo", "directionalInfo", "lvrInfo", "matchScore", "standardizedAddress1", "standardizedAddress2",
         "standardizedAddress3", "standardizedAddress4", "standardizedAddressNoApt", "standardizedCity",
         "standardizedCounty", "standardizedCSP", "standardizedState", "standardizedPostalCode", "standardizedCountry",
         "standardizedISOCountry", "stateInfo", "streetInfo", "suffixInfo", "postalCodeInfo", "overallInfo", "usInfo",
         "caInfo", "intlInfo", "usErrorInfo", "caErrorInfo", "intlErrorInfo"
    })
