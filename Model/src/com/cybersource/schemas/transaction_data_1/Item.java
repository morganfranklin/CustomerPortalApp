 ...
 *       &lt;sequence&gt;
 *         &lt;element name="unitPrice" type="{urn:schemas-cybersource-com:transaction-data-1.137}amount" minOccurs="0"/&gt;
 *         &lt;element name="quantity" type="{urn:schemas-cybersource-com:transaction-data-1.137}amount" minOccurs="0"/&gt;
 ...
 *         &lt;element name="cityOverrideAmount" type="{urn:schemas-cybersource-com:transaction-data-1.137}amount" minOccurs="0"/&gt;
 *         &lt;element name="cityOverrideRate" type="{urn:schemas-cybersource-com:transaction-data-1.137}amount" minOccurs="0"/&gt;
 *         &lt;element name="countyOverrideAmount" type="{urn:schemas-cybersource-com:transaction-data-1.137}amount" minOccurs="0"/&gt;
 *         &lt;element name="countyOverrideRate" type="{urn:schemas-cybersource-com:transaction-data-1.137}amount" minOccurs="0"/&gt;
 *         &lt;element name="districtOverrideAmount" type="{urn:schemas-cybersource-com:transaction-data-1.137}amount" minOccurs="0"/&gt;
 *         &lt;element name="districtOverrideRate" type="{urn:schemas-cybersource-com:transaction-data-1.137}amount" minOccurs="0"/&gt;
 *         &lt;element name="stateOverrideAmount" type="{urn:schemas-cybersource-com:transaction-data-1.137}amount" minOccurs="0"/&gt;
 *         &lt;element name="stateOverrideRate" type="{urn:schemas-cybersource-com:transaction-data-1.137}amount" minOccurs="0"/&gt;
 *         &lt;element name="countryOverrideAmount" type="{urn:schemas-cybersource-com:transaction-data-1.137}amount" minOccurs="0"/&gt;
 *         &lt;element name="countryOverrideRate" type="{urn:schemas-cybersource-com:transaction-data-1.137}amount" minOccurs="0"/&gt;
 ...
 *         &lt;element name="nationalTax" type="{urn:schemas-cybersource-com:transaction-data-1.137}amount" minOccurs="0"/&gt;
 *         &lt;element name="vatRate" type="{urn:schemas-cybersource-com:transaction-data-1.137}amount" minOccurs="0"/&gt;
 ...
 *         &lt;element name="giftCategory" type="{urn:schemas-cybersource-com:transaction-data-1.137}boolean" minOccurs="0"/&gt;
 ...
 *         &lt;element name="taxRate" type="{urn:schemas-cybersource-com:transaction-data-1.137}amount" minOccurs="0"/&gt;
 *         &lt;element name="totalAmount" type="{urn:schemas-cybersource-com:transaction-data-1.137}amount" minOccurs="0"/&gt;
 *         &lt;element name="discountAmount" type="{urn:schemas-cybersource-com:transaction-data-1.137}amount" minOccurs="0"/&gt;
 *         &lt;element name="discountRate" type="{urn:schemas-cybersource-com:transaction-data-1.137}amount" minOccurs="0"/&gt;
 ...
 *         &lt;element name="alternateTaxAmount" type="{urn:schemas-cybersource-com:transaction-data-1.137}amount" minOccurs="0"/&gt;
 *         &lt;element name="alternateTaxTypeApplied" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *         &lt;element name="alternateTaxRate" type="{urn:schemas-cybersource-com:transaction-data-1.137}amount" minOccurs="0"/&gt;
 *         &lt;element name="alternateTaxType" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *         &lt;element name="localTax" type="{urn:schemas-cybersource-com:transaction-data-1.137}amount" minOccurs="0"/&gt;
...
@XmlType(name = "Item", propOrder = {
         "unitPrice", "quantity", "productCode", "productName", "productSKU", "productRisk", "taxAmount",
         "cityOverrideAmount", "cityOverrideRate", "countyOverrideAmount", "countyOverrideRate",
         "districtOverrideAmount", "districtOverrideRate", "stateOverrideAmount", "stateOverrideRate",
         "countryOverrideAmount", "countryOverrideRate", "orderAcceptanceCity", "orderAcceptanceCounty",
         "orderAcceptanceCountry", "orderAcceptanceState", "orderAcceptancePostalCode", "orderOriginCity",
         "orderOriginCounty", "orderOriginCountry", "orderOriginState", "orderOriginPostalCode", "shipFromCity",
         "shipFromCounty", "shipFromCountry", "shipFromState", "shipFromPostalCode", "export", "noExport",
         "nationalTax", "vatRate", "sellerRegistration", "sellerRegistration0", "sellerRegistration1",
         "sellerRegistration2", "sellerRegistration3", "sellerRegistration4", "sellerRegistration5",
         "sellerRegistration6", "sellerRegistration7", "sellerRegistration8", "sellerRegistration9",
         "buyerRegistration", "middlemanRegistration", "pointOfTitleTransfer", "giftCategory", "timeCategory",
         "hostHedge", "timeHedge", "velocityHedge", "nonsensicalHedge", "phoneHedge", "obscenitiesHedge",
         "unitOfMeasure", "taxRate", "totalAmount", "discountAmount", "discountRate", "commodityCode",
         "grossNetIndicator", "taxTypeApplied", "discountIndicator", "alternateTaxID", "alternateTaxAmount",
         "alternateTaxTypeApplied", "alternateTaxRate", "alternateTaxType", "localTax", "zeroCostToCustomerIndicator",
         "passengerFirstName", "passengerLastName", "passengerID", "passengerStatus", "passengerType", "passengerEmail",
         "passengerPhone", "invoiceNumber", "productDescription", "taxStatusIndicator", "discountManagementIndicator",
         "typeOfSupply", "sign", "unitTaxAmount"
    })
public class Item {
