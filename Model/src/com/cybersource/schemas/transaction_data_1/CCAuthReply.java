 ...
 *         &lt;element name="fxQuoteRate" type="{urn:schemas-cybersource-com:transaction-data-1.137}dateTime" minOccurs="0"/&gt;
 *         &lt;element name="fxQuoteType" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *         &lt;element name="fxQuoteExpirationDateTime" type="{urn:schemas-cybersource-com:transaction-data-1.137}dateTime" minOccurs="0"/&gt;
 ...
 *         &lt;element name="accountBalance" type="{urn:schemas-cybersource-com:transaction-data-1.137}amount" minOccurs="0"/&gt;
 ...
 *         &lt;element name="requestAmount" type="{urn:schemas-cybersource-com:transaction-data-1.137}amount" minOccurs="0"/&gt;
...
@XmlType(name = "CCAuthReply", propOrder = {
         "reasonCode", "amount", "authorizationCode", "avsCode", "avsCodeRaw", "cvCode", "cvCodeRaw", "personalIDCode",
         "authorizedDateTime", "processorResponse", "bmlAccountNumber", "authFactorCode", "reconciliationID",
         "fundingTotals", "fxQuoteID", "fxQuoteRate", "fxQuoteType", "fxQuoteExpirationDateTime", "authRecord",
         "merchantAdviceCode", "merchantAdviceCodeRaw", "cavvResponseCode", "cavvResponseCodeRaw", "authenticationXID",
         "authorizationXID", "processorCardType", "accountBalance", "forwardCode", "enhancedDataEnabled",
         "referralResponseNumber", "subResponseCode", "approvedAmount", "creditLine", "approvedTerms",
         "paymentNetworkTransactionID", "cardCategory", "ownerMerchantID", "requestAmount", "requestCurrency",
         "accountBalanceCurrency", "accountBalanceSign", "amountType", "accountType", "affluenceIndicator", "evEmail",
         "evPhoneNumber", "evPostalCode", "evName", "evStreet", "evEmailRaw", "evPhoneNumberRaw", "evPostalCodeRaw",
         "evNameRaw", "evStreetRaw", "cardGroup", "posData", "transactionID", "cardIssuerCountry", "cardRegulated",
         "cardCommercial", "cardPrepaid", "cardPayroll", "cardHealthcare", "cardSignatureDebit", "cardPINlessDebit",
         "cardLevel3Eligible", "processorTransactionID", "providerReasonCode", "providerReasonDescription",
         "providerPassThroughData", "providerCVNResponseCode", "providerAVSResponseCode", "providerAcquirerBankCode",
         "paymentCardService", "paymentCardServiceResult", "transactionQualification", "transactionIntegrity",
         "emsTransactionRiskScore", "reconciliationReferenceNumber"
    })
