...
/**
 * <p>Java class for BankTransferReply complex type.
 *
...
@XmlType(name = "BankTransferReply", propOrder = {
         "reasonCode", "accountHolder", "accountNumber", "amount", "bankName", "bankCity", "bankCountry",
         "paymentReference", "processorResponse", "bankSwiftCode", "bankSpecialID", "requestDateTime",
         "reconciliationID", "iban", "bankCode", "branchCode", "reconciliationReferenceNumber"
    })
public class BankTransferReply {
    ...
    /**
     * Gets the value of the bankSpecialID property.
     *
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Sets the value of the bankSpecialID property.
     *
     * @param value
     *     allowed object is
     *     {@link String }
