 ...
 *       &lt;sequence&gt;
 *         &lt;element name="cookiesEnabled" type="{urn:schemas-cybersource-com:transaction-data-1.137}boolean" minOccurs="0"/&gt;
 *         &lt;element name="flashEnabled" type="{urn:schemas-cybersource-com:transaction-data-1.137}boolean" minOccurs="0"/&gt;
 *         &lt;element name="hash" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *         &lt;element name="imagesEnabled" type="{urn:schemas-cybersource-com:transaction-data-1.137}boolean" minOccurs="0"/&gt;
 *         &lt;element name="javascriptEnabled" type="{urn:schemas-cybersource-com:transaction-data-1.137}boolean" minOccurs="0"/&gt;
...
@XmlType(name = "DeviceFingerprint", propOrder = {
         "cookiesEnabled", "flashEnabled", "hash", "imagesEnabled", "javascriptEnabled", "proxyIPAddress",
         "proxyIPAddressActivities", "proxyIPAddressAttributes", "proxyServerType", "trueIPAddress",
         "trueIPAddressActivities", "trueIPAddressAttributes", "trueIPAddressCity", "trueIPAddressState",
         "trueIPAddressCountry", "smartID", "smartIDConfidenceLevel", "screenResolution", "browserLanguage",
         "agentType", "dateTime", "profileDuration", "profiledURL", "timeOnPage", "deviceMatch", "firstEncounter",
         "flashOS", "flashVersion", "deviceLatitude", "deviceLongitude", "gpsAccuracy", "jbRoot", "jbRootReason"
    })
