...
@XmlType(name = "PinDebitPurchaseReply", propOrder = {
         "reasonCode", "processorResponse", "authorizationCode", "reconciliationID", "networkCode", "transactionID",
         "requestAmount", "requestCurrency", "amount", "dateTime", "accountType", "amountType", "accountBalance",
