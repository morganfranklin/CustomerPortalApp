 ...
 *         &lt;element name="returnAuthRecord" type="{urn:schemas-cybersource-com:transaction-data-1.137}boolean" minOccurs="0"/&gt;
 ...
 *         &lt;element name="billPayment" type="{urn:schemas-cybersource-com:transaction-data-1.137}boolean" minOccurs="0"/&gt;
 ...
 *         &lt;element name="partialAuthIndicator" type="{urn:schemas-cybersource-com:transaction-data-1.137}boolean" minOccurs="0"/&gt;
...
@XmlType(name = "CCAuthService", propOrder = {
         "cavv", "cavvAlgorithm", "commerceIndicator", "eciRaw", "xid", "reconciliationID", "avsLevel", "fxQuoteID",
         "returnAuthRecord", "authType", "verbalAuthCode", "billPayment", "authenticationXID", "authorizationXID",
         "industryDatatype", "traceNumber", "checksumKey", "aggregatorID", "aggregatorName", "splitTenderIndicator",
         "veresEnrolled", "paresStatus", "partialAuthIndicator", "captureDate", "firstRecurringPayment", "duration",
         "overridePaymentMethod", "mobileRemotePaymentType", "cardholderVerificationMethod", "dccRequestID",
