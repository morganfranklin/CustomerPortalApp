...
@XmlType(name = "ECCreditReply", propOrder = {
         "reasonCode", "settlementMethod", "requestDateTime", "amount", "processorTransactionID", "reconciliationID",
         "processorResponse", "verificationCode", "verificationCodeRaw", "correctedAccountNumber",
         "correctedRoutingNumber", "ownerMerchantID"
    })
