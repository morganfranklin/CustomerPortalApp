...
@XmlType(name = "PayPalDoCaptureReply", propOrder = {
         "reasonCode", "authorizationId", "transactionId", "parentTransactionId", "paypalReceiptId",
         "paypalTransactiontype", "paypalPaymentType", "paypalOrderTime", "paypalPaymentGrossAmount", "paypalFeeAmount",
         "paypalTaxAmount", "paypalExchangeRate", "paypalPaymentStatus", "amount", "currency", "correlationID",
         "errorCode", "paypalPendingReason"
    })
