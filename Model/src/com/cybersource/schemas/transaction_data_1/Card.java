...
@XmlType(name = "Card", propOrder = {
         "fullName", "accountNumber", "expirationMonth", "expirationYear", "cvIndicator", "cvNumber", "cardType",
         "issueNumber", "startMonth", "startYear", "pin", "accountEncoderID", "bin", "encryptedData", "suffix",
         "prefix", "cardTypeName", "cardSubType", "level2Eligible", "level3Eligible", "productCategory",
         "crossBorderIndicator", "billingCurrency", "billingCurrencyNumericCode", "billingCurrencyMinorDigits",
         "octFastFundsIndicator", "octBlockIndicator", "onlineGamblingBlockIndicator"
    })
public class Card {
