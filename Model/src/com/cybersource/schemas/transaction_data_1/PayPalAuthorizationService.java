...
@XmlType(name = "PayPalAuthorizationService", propOrder = {
         "paypalOrderId", "paypalEcOrderSetupRequestID", "paypalEcOrderSetupRequestToken",
         "paypalDoRefTransactionRequestID", "paypalDoRefTransactionRequestToken", "paypalCustomerEmail"
    })
