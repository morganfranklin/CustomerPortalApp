...
@XmlType(name = "PayPalEcGetDetailsReply", propOrder = {
         "reasonCode", "paypalToken", "payer", "payerId", "payerStatus", "payerSalutation", "payerFirstname",
         "payerMiddlename", "payerLastname", "payerSuffix", "payerCountry", "payerBusiness", "shipToName",
         "shipToAddress1", "shipToAddress2", "shipToCity", "shipToState", "shipToCountry", "shipToZip", "addressStatus",
         "payerPhone", "avsCode", "street1", "street2", "city", "state", "postalCode", "countryCode", "countryName",
         "addressID", "errorCode", "correlationID", "paypalBillingAgreementAcceptedStatus", "paypalTaxAmount", "item"
    })
