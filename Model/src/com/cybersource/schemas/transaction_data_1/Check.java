...
@XmlType(name = "Check", propOrder = {
         "fullName", "accountNumber", "accountType", "bankTransitNumber", "checkNumber", "secCode", "accountEncoderID",
         "authenticateID", "paymentInfo", "imageReferenceNumber", "terminalCity", "terminalState"
    })
public class Check {
