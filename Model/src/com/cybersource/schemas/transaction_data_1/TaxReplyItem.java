 ...
 *       &lt;sequence&gt;
 *         &lt;element name="taxableAmount" type="{urn:schemas-cybersource-com:transaction-data-1.137}amount" minOccurs="0"/&gt;
 *         &lt;element name="exemptAmount" type="{urn:schemas-cybersource-com:transaction-data-1.137}amount" minOccurs="0"/&gt;
 *         &lt;element name="specialTaxAmount" type="{urn:schemas-cybersource-com:transaction-data-1.137}amount" minOccurs="0"/&gt;
 *         &lt;element name="cityTaxAmount" type="{urn:schemas-cybersource-com:transaction-data-1.137}amount" minOccurs="0"/&gt;
 *         &lt;element name="countyTaxAmount" type="{urn:schemas-cybersource-com:transaction-data-1.137}amount" minOccurs="0"/&gt;
 *         &lt;element name="districtTaxAmount" type="{urn:schemas-cybersource-com:transaction-data-1.137}amount" minOccurs="0"/&gt;
 *         &lt;element name="stateTaxAmount" type="{urn:schemas-cybersource-com:transaction-data-1.137}amount" minOccurs="0"/&gt;
 *         &lt;element name="countryTaxAmount" type="{urn:schemas-cybersource-com:transaction-data-1.137}amount" minOccurs="0"/&gt;
 *         &lt;element name="totalTaxAmount" type="{urn:schemas-cybersource-com:transaction-data-1.137}amount"/&gt;
 *         &lt;element name="jurisdiction" type="{urn:schemas-cybersource-com:transaction-data-1.137}TaxReplyItemJurisdiction" maxOccurs="1000" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "TaxReplyItem", propOrder = {
         "taxableAmount", "exemptAmount", "specialTaxAmount", "cityTaxAmount", "countyTaxAmount", "districtTaxAmount",
         "stateTaxAmount", "countryTaxAmount", "totalTaxAmount", "jurisdiction"
    })
