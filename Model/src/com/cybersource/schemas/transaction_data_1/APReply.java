 ...
 *         &lt;element name="sellerProtection" type="{urn:schemas-cybersource-com:transaction-data-1.137}SellerProtection" minOccurs="0"/&gt;
...
@XmlType(name = "APReply", propOrder = {
         "orderID", "cardGroup", "cardType", "cardNumberSuffix", "cardExpirationMonth", "cardExpirationYear",
         "avsCodeRaw", "purchaseID", "productID", "productDescription", "shippingAmount", "handlingAmount",
         "shippingHandlingAmount", "additionalAmount", "taxAmount", "subtotalAmount", "totalPurchaseAmount",
         "giftWrapAmount", "discountAmount", "cardNumberPrefix", "riskIndicator", "merchantUUID", "merchantSiteID",
         "transactionExpirationDate", "sellerProtection", "processorFraudDecision", "processorFraudDecisionReason",
         "customerID", "billingAgreementID", "payerID", "fundingSource"
    })
