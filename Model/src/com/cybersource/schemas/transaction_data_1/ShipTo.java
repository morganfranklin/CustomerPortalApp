 ...
 *         &lt;element name="notApplicable" type="{urn:schemas-cybersource-com:transaction-data-1.137}boolean" minOccurs="0"/&gt;
 *         &lt;element name="immutable" type="{urn:schemas-cybersource-com:transaction-data-1.137}boolean" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "ShipTo", propOrder = {
         "title", "firstName", "middleName", "lastName", "suffix", "street1", "street2", "street3", "street4", "city",
         "county", "state", "buildingNumber", "district", "postalCode", "country", "company", "phoneNumber", "email",
         "shippingMethod", "name", "id", "addressVerificationStatus", "notApplicable", "immutable"
    })
public class ShipTo {
