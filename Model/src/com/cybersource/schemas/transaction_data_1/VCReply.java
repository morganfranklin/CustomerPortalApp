 ...
 *         &lt;element name="cardArt" type="{urn:schemas-cybersource-com:transaction-data-1.137}VCCardArt" minOccurs="0"/&gt;
 ...
 *         &lt;element name="customData" type="{urn:schemas-cybersource-com:transaction-data-1.137}VCCustomData" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "VCReply", propOrder = {
         "creationTimeStamp", "alternateShippingAddressCountryCode", "alternateShippingAddressPostalCode",
         "vcAccountLoginName", "vcAccountFirstName", "vcAccountLastName", "vcAccountEncryptedID", "vcAccountEmail",
         "vcAccountMobilePhoneNumber", "merchantReferenceID", "subtotalAmount", "shippingHandlingAmount", "taxAmount",
         "discountAmount", "giftWrapAmount", "uncategorizedAmount", "totalPurchaseAmount", "walletReferenceID",
         "promotionCode", "paymentInstrumentID", "cardVerificationStatus", "issuerID", "paymentInstrumentNickName",
         "nameOnCard", "cardType", "cardGroup", "cardArt", "riskAdvice", "riskScore", "riskAdditionalData",
         "avsCodeRaw", "cvnCodeRaw", "eciRaw", "eci", "cavv", "veresEnrolled", "veresTimeStamp", "paresStatus",
         "paresTimeStamp", "xid", "customData"
    })
