 ...
 *         &lt;element name="httpBrowserCookiesAccepted" type="{urn:schemas-cybersource-com:transaction-data-1.137}boolean" minOccurs="0"/&gt;
...
@XmlType(name = "BillTo", propOrder = {
         "title", "firstName", "middleName", "lastName", "suffix", "buildingNumber", "street1", "street2", "street3",
         "street4", "city", "district", "county", "state", "postalCode", "country", "company", "companyTaxID",
         "phoneNumber", "email", "ipAddress", "customerUserName", "customerPassword", "ipNetworkAddress", "hostname",
         "domainName", "dateOfBirth", "driversLicenseNumber", "driversLicenseState", "ssn", "customerID",
         "httpBrowserType", "httpBrowserEmail", "httpBrowserCookiesAccepted", "nif", "personalID", "language", "name",
         "gender", "merchantTaxID"
    })
public class BillTo {
