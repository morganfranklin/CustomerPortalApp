...
@XmlType(name = "PayPalTransactionSearchService", propOrder = {
         "startDate", "endDate", "paypalCustomerEmail", "paypalReceiptId", "transactionID", "invoiceNumber",
         "grandTotalAmount", "currency", "paymentStatus", "payerSalutation", "payerFirstname", "payerMiddlename",
         "payerLastname", "payerSuffix"
    })
