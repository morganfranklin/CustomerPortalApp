...
@XmlType(name = "CCSaleReply", propOrder = {
         "reasonCode", "amount", "authorizationCode", "processorResponse", "avsCode", "avsCodeRaw", "cvCode",
         "cvCodeRaw", "cavvResponseCode", "cavvResponseCodeRaw", "cardGroup", "paymentNetworkTransactionID",
         "cardCategory", "accountBalance", "authorizedDateTime", "requestAmount", "reconciliationID",
         "accountBalanceCurrency", "accountBalanceSign"
    })
