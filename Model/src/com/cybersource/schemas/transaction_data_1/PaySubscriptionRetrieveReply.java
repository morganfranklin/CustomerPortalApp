...
@XmlType(name = "PaySubscriptionRetrieveReply", propOrder = {
         "reasonCode", "approvalRequired", "automaticRenew", "cardAccountNumber", "cardExpirationMonth",
         "cardExpirationYear", "cardIssueNumber", "cardStartMonth", "cardStartYear", "cardType", "checkAccountNumber",
         "checkAccountType", "checkBankTransitNumber", "checkSecCode", "checkAuthenticateID", "city", "comments",
         "companyName", "country", "currency", "customerAccountID", "email", "endDate", "firstName", "frequency",
         "lastName", "merchantReferenceCode", "paymentMethod", "paymentsRemaining", "phoneNumber", "postalCode",
         "recurringAmount", "setupAmount", "startDate", "state", "status", "street1", "street2", "subscriptionID",
         "subscriptionIDNew", "title", "totalPayments", "shipToFirstName", "shipToLastName", "shipToStreet1",
         "shipToStreet2", "shipToCity", "shipToState", "shipToPostalCode", "shipToCompany", "shipToCountry",
         "billPayment", "merchantDefinedDataField1", "merchantDefinedDataField2", "merchantDefinedDataField3",
         "merchantDefinedDataField4", "merchantSecureDataField1", "merchantSecureDataField2",
         "merchantSecureDataField3", "merchantSecureDataField4", "ownerMerchantID", "companyTaxID",
         "driversLicenseNumber", "driversLicenseState", "dateOfBirth", "instrumentIdentifierID",
         "instrumentIdentifierStatus", "instrumentIdentifierIDNew"
    })
