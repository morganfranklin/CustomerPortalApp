...
@XmlType(name = "Installment", propOrder = {
         "sequence", "totalCount", "totalAmount", "frequency", "amount", "planType", "firstInstallmentDate",
         "amountFunded", "amountRequestedPercentage", "expenses", "expensesPercentage", "fees", "feesPercentage",
         "taxes", "taxesPercentage", "insurance", "insurancePercentage", "additionalCosts", "additionalCostsPercentage",
         "monthlyInterestRate", "annualInterestRate", "annualFinancingCost", "paymentType", "invoiceData"
    })
