 ...
 *         &lt;element name="isGift" type="{urn:schemas-cybersource-com:transaction-data-1.137}boolean" minOccurs="0"/&gt;
 *         &lt;element name="returnsAccepted" type="{urn:schemas-cybersource-com:transaction-data-1.137}boolean" minOccurs="0"/&gt;
 ...
 *         &lt;element name="taxable" type="{urn:schemas-cybersource-com:transaction-data-1.137}boolean" minOccurs="0"/&gt;
...
@XmlType(name = "InvoiceHeader", propOrder = {
         "merchantDescriptor", "merchantDescriptorContact", "merchantDescriptorAlternate", "merchantDescriptorStreet",
         "merchantDescriptorCity", "merchantDescriptorState", "merchantDescriptorPostalCode",
         "merchantDescriptorCountry", "isGift", "returnsAccepted", "tenderType", "merchantVATRegistrationNumber",
         "purchaserOrderDate", "purchaserVATRegistrationNumber", "vatInvoiceReferenceNumber", "summaryCommodityCode",
         "supplierOrderReference", "userPO", "costCenter", "purchaserCode", "taxable", "amexDataTAA1", "amexDataTAA2",
         "amexDataTAA3", "amexDataTAA4", "invoiceDate", "totalTaxTypeCode", "cardAcceptorRefNumber",
         "authorizedContactName", "businessApplicationID", "salesOrganizationID", "submerchantID", "submerchantName",
         "submerchantStreet", "submerchantCity", "submerchantPostalCode", "submerchantState", "submerchantCountry",
         "submerchantEmail", "submerchantTelephoneNumber", "submerchantRegion", "submerchantMerchantID"
    })
