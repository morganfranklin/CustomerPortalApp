...
@XmlType(name = "CCCreditService", propOrder = {
         "captureRequestID", "reconciliationID", "partialPaymentID", "purchasingLevel", "industryDatatype",
         "commerceIndicator", "billPayment", "authorizationXID", "occurrenceNumber", "authCode", "captureRequestToken",
         "merchantReceiptNumber", "checksumKey", "aggregatorID", "aggregatorName", "duration", "dpdeBillingMonth",
         "reconciliationIDAlternate", "refundReason", "overridePaymentMethod", "overridePaymentDetails"
    })
