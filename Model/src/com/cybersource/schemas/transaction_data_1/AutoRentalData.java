 ...
 *       &lt;sequence&gt;
 *         &lt;element name="adjustmentCost" type="{urn:schemas-cybersource-com:transaction-data-1.137}amount" minOccurs="0"/&gt;
 ...
 *         &lt;element name="dailyRate" type="{urn:schemas-cybersource-com:transaction-data-1.137}amount" minOccurs="0"/&gt;
 *         &lt;element name="mileageCost" type="{urn:schemas-cybersource-com:transaction-data-1.137}amount" minOccurs="0"/&gt;
 *         &lt;element name="gasCost" type="{urn:schemas-cybersource-com:transaction-data-1.137}amount" minOccurs="0"/&gt;
 *         &lt;element name="insuranceCost" type="{urn:schemas-cybersource-com:transaction-data-1.137}amount" minOccurs="0"/&gt;
 *         &lt;element name="lateReturnCost" type="{urn:schemas-cybersource-com:transaction-data-1.137}amount" minOccurs="0"/&gt;
 ...
 *         &lt;element name="oneWayCost" type="{urn:schemas-cybersource-com:transaction-data-1.137}amount" minOccurs="0"/&gt;
 *         &lt;element name="parkingViolationCost" type="{urn:schemas-cybersource-com:transaction-data-1.137}amount" minOccurs="0"/&gt;
 ...
 *         &lt;element name="ratePerMile" type="{urn:schemas-cybersource-com:transaction-data-1.137}amount" minOccurs="0"/&gt;
...
@XmlType(name = "AutoRentalData", propOrder = {
         "adjustmentCost", "adjustmentCode", "agreementNumber", "classCode", "customerServicePhoneNumber", "dailyRate",
         "mileageCost", "gasCost", "insuranceCost", "lateReturnCost", "maximumFreeMiles", "milesTraveled", "oneWayCost",
         "parkingViolationCost", "pickUpCity", "pickUpCountry", "pickUpDate", "pickUpState", "pickUpTime",
         "ratePerMile", "renterName", "returnCity", "returnCountry", "returnDate", "returnLocationID", "returnState",
         "returnTime", "specialProgramCode"
    })
