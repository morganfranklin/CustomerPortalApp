 ...
 *         &lt;element name="dutyAmount" type="{urn:schemas-cybersource-com:transaction-data-1.137}amount" minOccurs="0"/&gt;
 ...
 *         &lt;element name="freightAmount" type="{urn:schemas-cybersource-com:transaction-data-1.137}amount" minOccurs="0"/&gt;
 *         &lt;element name="freightAmountSign" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *         &lt;element name="foreignAmount" type="{urn:schemas-cybersource-com:transaction-data-1.137}amount" minOccurs="0"/&gt;
 *         &lt;element name="foreignCurrency" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *         &lt;element name="originalAmount" type="{urn:schemas-cybersource-com:transaction-data-1.137}amount" minOccurs="0"/&gt;
 *         &lt;element name="originalCurrency" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *         &lt;element name="exchangeRate" type="{urn:schemas-cybersource-com:transaction-data-1.137}amount" minOccurs="0"/&gt;
 ...
 *         &lt;element name="serviceFeeAmount" type="{urn:schemas-cybersource-com:transaction-data-1.137}amount" minOccurs="0"/&gt;
 *         &lt;element name="subtotalAmount" type="{urn:schemas-cybersource-com:transaction-data-1.137}amount" minOccurs="0"/&gt;
 *         &lt;element name="shippingAmount" type="{urn:schemas-cybersource-com:transaction-data-1.137}amount" minOccurs="0"/&gt;
 *         &lt;element name="handlingAmount" type="{urn:schemas-cybersource-com:transaction-data-1.137}amount" minOccurs="0"/&gt;
 *         &lt;element name="shippingHandlingAmount" type="{urn:schemas-cybersource-com:transaction-data-1.137}amount" minOccurs="0"/&gt;
 *         &lt;element name="shippingDiscountAmount" type="{urn:schemas-cybersource-com:transaction-data-1.137}amount" minOccurs="0"/&gt;
 *         &lt;element name="giftWrapAmount" type="{urn:schemas-cybersource-com:transaction-data-1.137}amount" minOccurs="0"/&gt;
 *         &lt;element name="insuranceAmount" type="{urn:schemas-cybersource-com:transaction-data-1.137}amount" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "PurchaseTotals", propOrder = {
         "currency", "discountAmount", "discountAmountSign", "discountManagementIndicator", "taxAmount", "dutyAmount",
         "dutyAmountSign", "grandTotalAmount", "freightAmount", "freightAmountSign", "foreignAmount", "foreignCurrency",
         "originalAmount", "originalCurrency", "exchangeRate", "exchangeRateTimeStamp", "additionalAmountType0",
         "additionalAmount0", "additionalAmountType1", "additionalAmount1", "additionalAmountType2",
         "additionalAmount2", "additionalAmountType3", "additionalAmount3", "additionalAmountType4",
         "additionalAmount4", "serviceFeeAmount", "subtotalAmount", "shippingAmount", "handlingAmount",
         "shippingHandlingAmount", "shippingDiscountAmount", "giftWrapAmount", "insuranceAmount"
    })
