...
@XmlType(name = "Leg", propOrder = {
         "carrierCode", "flightNumber", "originatingAirportCode", "clazz", "stopoverCode", "departureDate",
         "destination", "fareBasis", "departTax", "conjunctionTicket", "exchangeTicket", "couponNumber",
         "departureTime", "departureTimeSegment", "arrivalTime", "arrivalTimeSegment", "endorsementsRestrictions",
         "fare", "fee", "tax"
    })
public class Leg {
