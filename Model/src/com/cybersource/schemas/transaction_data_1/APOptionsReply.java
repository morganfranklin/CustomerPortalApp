...
/**
 * <p>Java class for APOptionsReply complex type.
 *
 ...
 *         &lt;element name="option" type="{urn:schemas-cybersource-com:transaction-data-1.137}APOptionsOption" maxOccurs="250" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "APOptionsReply", propOrder = {
         "reasonCode", "responseCode", "offset", "count", "totalCount", "option" })
public class APOptionsReply {
    ...
    public List<APOptionsOption> getOption() {
        if (option == null) {
            option = new ArrayList<APOptionsOption>();
        }
        return this.option;
    }
