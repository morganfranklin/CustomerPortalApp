 ...
 *         &lt;element name="deviceFingerprint" type="{urn:schemas-cybersource-com:transaction-data-1.137}DeviceFingerprint" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "AFSReply", propOrder = {
         "reasonCode", "afsResult", "hostSeverity", "consumerLocalTime", "afsFactorCode", "addressInfoCode",
         "hotlistInfoCode", "internetInfoCode", "phoneInfoCode", "suspiciousInfoCode", "velocityInfoCode",
         "identityInfoCode", "ipCountry", "ipState", "ipCity", "ipRoutingMethod", "ipAnonymizerStatus",
         "scoreModelUsed", "cardBin", "binCountry", "cardAccountType", "cardScheme", "cardIssuer", "deviceFingerprint"
    })
