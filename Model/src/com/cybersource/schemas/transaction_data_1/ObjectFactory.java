...
public class ObjectFactory {
    ...
    private final static QName _RequestMessage_QNAME =
        new QName("urn:schemas-cybersource-com:transaction-data-1.137", "requestMessage");
    private final static QName _ReplyMessage_QNAME =
        new QName("urn:schemas-cybersource-com:transaction-data-1.137", "replyMessage");
    private final static QName _NvpRequest_QNAME =
        new QName("urn:schemas-cybersource-com:transaction-data-1.137", "nvpRequest");
    private final static QName _NvpReply_QNAME =
        new QName("urn:schemas-cybersource-com:transaction-data-1.137", "nvpReply");
    private final static QName _FaultDetails_QNAME =
        new QName("urn:schemas-cybersource-com:transaction-data-1.137", "faultDetails");
     ...
     *
     */
    @XmlElementDecl(namespace = "urn:schemas-cybersource-com:transaction-data-1.137", name = "requestMessage")
     ...
     *
     */
    @XmlElementDecl(namespace = "urn:schemas-cybersource-com:transaction-data-1.137", name = "replyMessage")
     ...
     *
     */
    @XmlElementDecl(namespace = "urn:schemas-cybersource-com:transaction-data-1.137", name = "nvpRequest")
     ...
     *
     */
    @XmlElementDecl(namespace = "urn:schemas-cybersource-com:transaction-data-1.137", name = "nvpReply")
     ...
     *
     */
    @XmlElementDecl(namespace = "urn:schemas-cybersource-com:transaction-data-1.137", name = "faultDetails")
