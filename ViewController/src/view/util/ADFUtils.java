...
public class ADFUtils {
     ...
     */
     public static ApplicationModule getApplicationModuleForDataControl(String name) {
       ...
       DCDataControl dc =
         bindingContext.findDataControl(name); // Name of application module in datacontrolBinding.cpx
    ...
    public static BindingContainer getBindingContainerOfOtherPage(String pageUsageId) {
        return (BindingContainer)JSFUtils.resolveExpression("#{data." +
                                                            pageUsageId + "}");
    }
    ...
    public static List executeOperationBinding(String method,
        ...
        oracle.binding.OperationBinding operation =
    ...
    public static List executeOperationBinding(String method) {
        ...
        OperationBinding operationBinding =
            (OperationBinding)bindings.getOperationBinding(method);
        try {
